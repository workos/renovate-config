...
Centralize GitHub Actions dependency-management policy across the org so that a single edit propagates to every consuming repo. The preset is the implementation of [SECENG-299](https://linear.app/workos/issue/SECENG-299/) and the supply-chain hardening work tracked in the [INC-589 follow-up project](https://linear.app/workos/project/inc-589-axios-compromise-github-actions).
